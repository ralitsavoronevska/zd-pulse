    ...
    <header class="layout-topbar backdrop-blur-2xl">
        ...
        <div class="layout-topbar-actions">
            <div class="layout-config-menu flex items-center gap-4">
                ...
                <Button id="logout-button" label="Log out" icon="pi pi-sign-out" class="p-button-danger p-button-rounded p-button-raised" @click="handleLogout" severity="danger" :loading="authStore.isLoading" />
            </div>
        </div>
    </header>
</template>
