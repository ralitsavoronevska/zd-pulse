...
const stats = computed(() => {
    ...
    return [
        ...
        { title: 'Unoffered Tickets', icon: 'pi pi-minus-circle', color: 'gray-500', summaryValue: a.unratedTickets, primaryDetails: a.unratedTickets, secondaryDetails: `${a.pctUnratedTickets}% of all tickets unoffered` },
