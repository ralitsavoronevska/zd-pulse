...
const tom0 = new Date(today0);
tom0.setDate(tom0.getDate() + 1);
const d7 = new Date(today0);
d7.setDate(d7.getDate() - 7);
const d1mo = new Date(today0);
d1mo.setMonth(d1mo.getMonth() - 1);
const d2mo = new Date(today0);
d2mo.setMonth(d2mo.getMonth() - 2);
const d3mo = new Date(today0);
